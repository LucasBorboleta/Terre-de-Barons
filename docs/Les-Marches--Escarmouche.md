...
La variante "Escarmouche" se joue uniquement à 2 joueurs.

## Matériel

- 12 Tuiles carrées : 3 T1, 3T2, 3 T3 et 3 T4
- Par joueur:
  - Un mini-Deck de Cartes crédits : 
    - 3 Cartes de 3 crédits, 
    - 4 Cartes de 2 crédits, 
    - 2 Cartes de 1 crédit
  - Grille mémo avec piste de score
  - 1 Suzerain
  - 2 Sénéchaux
  - 15 Compagnies
  - 5 Donjons
  - 1 cube marqueur de score
...
- Chaque joueur prend en main 3 cartes de crédits.

## Déplacement du Suzerain

Voici les contraintes de déplacement du Suzerain (ex Baron) : 

* Votre Suzerain peut traverser un Fief adverse ou une Terre occupée par un Suzerain adversaire <=> il rase les murs.

* Votre Suzerain ne peut pas s'arrêter sur un Fief adverse (une Terre avec un Donjon adverse)

* Votre Suzerain ne peut pas s'arrêter sur une Terre occupée par un Suzerain adversaire.

## Rappel sur le recrutement

Il est tout à fait possible de recruter en présence de Compagnies adversaires, mais vos Compagnies recrutées affrontent aussitôt les Compagnies adversaires présentes
